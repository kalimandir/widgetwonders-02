...
const DonationWidget: React.FC<DonationWidgetProps> = ({
  ...
  return (
    <div className={cn(
      "w-full max-w-md mx-auto bg-white rounded-3xl shadow-lg overflow-hidden transition-all duration-500",
      ...
      <div className="p-6 sm:p-8 flex flex-col items-center">
        {/* Logo */}
        <div className={cn(
          "w-20 h-20 rounded-2xl overflow-hidden shadow-md mb-4 transition-all",
        ...
        <div className={cn(
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-1">{organizationName}</h2>
          <p className="text-gray-600">{missionStatement}</p>
        </div>

        {/* Donation amounts */}
        <div className={cn(
          "w-full grid grid-cols-2 gap-4 mb-6 transition-all duration-700 delay-300",
          animateIn ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
        )}>
        ...
        {/* Custom amount */}
        <div className={cn(
          "w-full mb-8 transition-all duration-700 delay-400",
          animateIn ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
        )}>
          <CustomAmount
